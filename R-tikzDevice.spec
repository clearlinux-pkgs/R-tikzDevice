...
Version  : 0.12.5
Release  : 46
URL      : https://cran.r-project.org/src/contrib/tikzDevice_0.12.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tikzDevice_0.12.5.tar.gz
...
%prep
%setup -q -n tikzDevice
pushd ..
cp -a tikzDevice buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692382743
